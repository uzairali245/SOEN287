    ...
    <div class="signup-container">
        <form action="">
            ...
            <div>
                ...
                <input class="signup-input" type="text" name="username" placeholder="Enter your username here" value="">


            </div>
            <div>
                <label>Password</label>
                <input class="signup-input" type="password" name="password" placeholder="Enter your password here" value="">
            </div>

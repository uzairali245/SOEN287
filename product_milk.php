    ...
    <div class="content-container">
        <section class="section-products content-without-footer">
            ...
            <div class="custom-row">
                ...
                <div class="colmn one-third">
                    <div>
                        <img src="resources/img/dairy/milk.jpg" alt="product image">
                    </div>
                </div>
                ...
                <div class="colmn one-third">
                    <div class="product-info">
                        ...
                        <div class="product-info-element">
                            <h3 id="manufacturer">Cow</h3>
                            <h3 id="product-name">Milk</h3>
                        </div>

                        <div class="product-info-element">
                            <h3 id="price-per-unit">5$</h3>
                        </div>
...
document.querySelector(".description").innerHTML="Milk from cows. Ingredients made with 100% cow milk.";

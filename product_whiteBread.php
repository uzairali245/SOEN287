    ...
    <div class="content-container">
        <section class="section-products content-without-footer">
            ...
            <div class="custom-row">
                ...
                <div class="colmn one-third">
                    <div>
                        <img src="resources/img/bakery/bakery-white-bread2.jpg" alt="product image">
                    </div>
                </div>
                ...
                <div class="colmn one-third">
                    <div class="product-info">
                        ...
                        <div class="product-info-element">
                            ...
                            <h3 id="product-name">White Bread</h3>
                        </div>

                        <div class="product-info-element">
                            <h3 id="price-per-unit">7.00$/bag</h3>
                        </div>
...
document.querySelector(".description").innerHTML="Ingredients: Enriched flour, water, whole grain, wheat gluten, skim milk, high fructose corn syrup, sugar, yeast. Perfect for grilled cheese sandwiches, french toasts, croutons, bruschettas or whatever floats your boat...ahem ship.";
